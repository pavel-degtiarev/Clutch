			...
			<div className={containerStyles.popupContent}>
				<form
					...
					<div className={styles.fuelFields}>
						...
						/>
						<Field name="run" label="Пробег" units={FormUnits.RUN}
							auxStyles={styles.run} value={formState.run} numeric
						/>
						<Field name="cost" label="Стоимость" units={FormUnits.MONEY}
							auxStyles={styles.cost} value={formState.cost} numeric
						/>
						<Field name="price" label="Цена за литр" units={FormUnits.MONEY}
							auxStyles={styles.price} value={formState.price} numeric
						/>
						<Field name="volume" label="Объем" units={FormUnits.VOLUME}
